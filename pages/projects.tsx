    ...
    return (
        <>
            ...
            <ul className="text-red-500 text-3xl m-4">
                ...
                <li>Artificial Intelligence that learned how to play super mario</li>
                <li>Programming Robots via a Raspberry pi, using driver code to translate Python into Arduino microcontroller instructions</li>
            </ul>
        </>
    )
}